                      ...
                      this.state.productslist?.map((item, index) =>
                        <FormControlLabel
                          ...
                          control={<Checkbox
                            ...
                            defaultChecked={this.state?.searchProductChecked?.some(x => x === item.id)}
                            onChange={e => {

                              if (e.target.checked) {
                                let checked = item.id;
                                this.setState({
                                  searchProductChecked: [...this.state.searchProductChecked, checked]
                                }, () => {
                                  console.log(this.state.searchProductChecked)
                                })
                              } else {
                                let checked = item.id;
                                this.setState({
                                  searchProductChecked: this.state.searchProductChecked?.filter((e) => e != checked)
                                }, () => {
                                  console.log(this.state.searchProductChecked)
                                })
                              }
